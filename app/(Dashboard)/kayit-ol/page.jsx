            ...
            <div className="loginForm basis-3/5">
                <h2 className="text-2xl font-bold font-poppins">Kursbu App Platformuna Hoş Geldiniz!</h2>
                    <div className="mt-[40px]">
                        ...
                        <form className="grid grid-cols-1 gap-3 mt-[20px] md:grid-cols-2 lg:grid-cols-3">
                            <input
                                type="text"
                                name="name_surname"
                            ...
                            <input
                                ...
                                required
                            />
                            <select name="role" className="border border-slate-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-color-[#635fc7]">
                            ...
                            <div className="w-full flex items-center">
                                <input
                                    ...
                                    required
                                />
                                <label htmlFor="user_image" className="flex items-center bg-white text-black py-2 px-4 rounded-md cursor-pointer transition duration-200 hover:bg-gray-200">
                                <svg
                                    id="Layer_1"
