...
export default async function RightCards({teacherPage}) {
  ...
  <div
    ...
    >
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-bold">{teacherPage.teacher_private_lesson_topic}</h3>
      </div>
      <div className="flex flex-col justify-between items-start mt-[10px] md:mt-[20px]">
        <img
          src={teacherPage.teacher_photos}
          className="w-full rounded-[20px]"
          alt="Teacher"
        />
        <div className="mt-[10px] md:mt-0">
          <p className="font-bold text-lg">
            {teacherPage.teacher.name} {teacherPage.teacher.surname}
          </p>
          <p className="py-[5px]">{teacherPage.teacher_private_lesson_topic}</p>
          <p>
            {teacherPage.teacher_city} - {teacherPage.teacher_district}
          </p>
        </div>
      </div>
      <div className="flex justify-between items-center mt-[15px] md:mt-[25px]">
        <h3 className="text-lg font-bold">
          {teacherPage.teacher_lessons_price} TL
        </h3>
      </div>
      <div className="flex flex-col mt-4">
        <button className="w-full py-3 px-3 flex justify-center items-center text-center bg-[#8ac5fd]">
          ...
          >
            <path
              fillRule="evenodd"
              d="m14 10 1-8L2 14h9l-1 8 12-12z"
              clipRule="evenodd"
            ></path>
          </svg>
